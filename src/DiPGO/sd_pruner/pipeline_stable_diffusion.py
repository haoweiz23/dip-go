...
from .unet_2d_condition import UNet2DConditionModel as PrunerUNet2DConditionModel
from diffusers.pipelines.pipeline_utils import DiffusionPipeline, StableDiffusionMixin

# from .pruner import Pruner
from .pruner import ORDERED_BRANCH_NAME
...
class StableDiffusionPipeline(
    ...
    def __init__(
        ...
        unet: PrunerUNet2DConditionModel,
        ...
        is_unet_sample_size_less_64 = (
            hasattr(
                unet.config,
                "sample_size") and unet.config.sample_size < 64)
        ...
        # self.pruner = Pruner(args, unet) if pruner is None else pruner
        # self.pruner.all_queries_forward()
    ...
    def __call__(
        ...
        **kwargs,
        ...
        if gates is not None:
            ...
            all_timestep_gates = [
                {k: torch.Tensor([0, 1]).to(device) for k in ORDERED_BRANCH_NAME}
        ...
        if not return_dict:
            return (image, has_nsfw_concept, all_xts)
